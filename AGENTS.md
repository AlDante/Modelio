...
## Scope and intent
- This repo is an Eclipse RCP/Tycho monorepo for Modelio 5.4.1 (`Java 11`, Tycho `2.2.0`) centered on OSGi plugins, features, and packaged products.
...
- Prebuild validates target-definition modules first (`AGGREGATOR/prebuild/pom.xml` includes root and `dev-platform/rcp-target`).
